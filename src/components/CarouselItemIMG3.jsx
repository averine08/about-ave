...
const CarouselItemIMG3 = ({achievement, key, activeIdx}) => {
  ...
  return ( 
    ...
    <div className='rounded-md bg-biru-light_50 sm:py-10 sm:min-w-[100%] flex sm:flex-col items-center self-center sm:min-h-[600px] md:min-h-[560px] lg:min-h-full  sm:w-full transition-transform ease-in-out duration-500'  style={{  transform: `translateX(-${activeIdx *100}%)`}}> {/* jadi da rata  pas min-w diganti jadi 90% taidnya 100*/}
...
export default CarouselItemIMG3